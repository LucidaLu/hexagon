...
\input{crt/6-input-format}
\subsection[输出格式]{【输出格式】}
输出到文件 \filename{\enname.in} 中。
\input{crt/7-output-format}
\input{crt/generated-samples}

\subsection[数据范围]{【数据范围】}
\input{crt/8-testcases-spec}
\clearpage
